      ...
      <tr>
				<td align="center" valign="top">
                  ...
                  <h3>Hi {{ $user->first_name}}</h3>
									<h2><strong>This is to  inform you of a new appraisal for you on CloudHR</strong></h2>
		...
		<tr>
				<td align="center" valign="top">
                  ...
                  <a class="blue-btn" href="{{url('active-appraisals')}}"><strong>Access Appraisal</strong></a>
								</td>
							</tr>
						</table>
						<!-- // END BODY -->
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
						<tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								...
								<h6 style="text-align:center;margin-top: 9px;">CloudHR</h6>
								<h6 style="text-align:center;">developed by WIZAG &#8203;</h6>
							</td>
						</tr>
					</table>
				</td>
