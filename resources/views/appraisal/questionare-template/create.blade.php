		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="box box-success">
					...
					<div class="box-body">
						<form method="post" action="{{ url('appraisal-template-store')}}">
							{{csrf_field()}}
							...
							@foreach($questions as $question)
								<div class="form-group">
									<input type="checkbox" value="{{$question->id}}" name="questions[]"> &nbsp; {{$question->question}}
								</div>
							@endforeach
							...
							<div class="form-group">
								...
								<select name="designation_id" class="form-control" required="true">
									@foreach($designations as $designation)
										<option value="{{$designation->id}}">{{$designation->designation_item}}</option>
									@endforeach
								</select>
							</div>
							<div class="form-group">
