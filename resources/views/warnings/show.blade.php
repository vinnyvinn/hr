                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header">
                            <a href="{{url('warning') }}" class="btn btn-success">back</a>
    
                        </div>
                        <div class="box-body table-responsive no-padding">
                            <div class="row col-md-8 col-md-offset-2">
                        <form  action="{{ url('warning-send')}}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label> Title</label>
                                <input type="text" name="title" class="form-control" value="{{ $warning->title}} ">
                            </div>
                            <div class="form-group">
                                <label> Subject</label>
                                <input type="text" name="subject" class="form-control" value="{{ $warning->subject}} ">
                            </div>
                            <div class="form-group">
                                <label> Description</label>
                                 <textarea  name="description" class="form-control" rows="8" id="summernote">{{ $warning->description}}</textarea>
                            </div>
