                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">New Travel Mode</h3>
                        </div>
                        <div class="box-body">
                            <form method="POST" action="{{route('travel-mode.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">
{{csrf_field()}}                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required class="form-control" rows="3" name="description" cols="50" id="description"></textarea>
                                </div>
