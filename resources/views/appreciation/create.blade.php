                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header">
                            <a href="{{ url('appreciation') }}" class="box-title">back</a>
    
                        </div>
                        <div class="box-body table-responsive no-padding">
                            <div class="row col-md-8 col-md-offset-2">
                        <form  action="{{ url('appreciation')}}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label> Description</label>
                                 <textarea id="summernote" name="description" class="form-control summernote" rows="8"></textarea>
                            </div>
                            <div class="form-group">
