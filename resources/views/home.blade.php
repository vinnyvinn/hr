					...
					<div class="col-md-6">
						<div class="box box-success">
							<div class="box-header">
								...
								<div class="pull-right"><a href="{{url('users/'.Auth::id().'/edit')}}" class="btn pull-right btn-xs btn-success">update</a></div>
							</div>
							<div class="box-body no-padding">
								<table class="table">
									<tbody>
									...
									<tr>
										...
										<td>{{ Auth::user()->family_contact }}</td>
									</tr>
									<tr>
										<td style="width: 10px" class="text-center"><i class="fa fa-mobile-phone"></i></td>
										<td><strong>Emergency Contact</strong></td>
										<td>{{ Auth::user()->emergency_contact }}</td>
									</tr>
									<tr>
										<td style="width: 10px" class="text-center"><i class="fa fa-map-marker"></i></td>
