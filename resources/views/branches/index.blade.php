            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if(Auth::user()->role->role_permission('create_leaves'))
                        <a href="{{ asset('/branches/create') }}" type="button" class="btn btn-success btn-flat margin">New Zone</a>
                    @endif
                                            ...
                                            <td class="">
                                                <div class="btn-group">
                                                    @if(Auth::user()->role->role_permission('edit_leaves') )
                                                        <a href="{{ asset('branches/'.$branch->id.'/edit') }}" title="Edit" class="btn btn-default btn-flat btn-sm"><i class="fa fa-pencil"></i></a>
                                                    @endif
                                                    @if(Auth::user()->role->role_permission('delete_leaves') )
                                                        <a type="button" class="btn btn-default btn-flat btn-sm" title="Delete" data-toggle="modal" data-target="#deleteModal{{ $branch->id }}"><i class="fa fa-trash"></i></a>
                                                        <div id="deleteModal{{ $branch->id }}" class="modal fade" role="dialog">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        {!! Form::open(['url' => ['branches/'.$branch->id], 'method' => 'delete']) !!}
