                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">New Training Type</h3>
                        </div>
                        <div class="box-body">
                            <form method="POST" action="{{route('training-types.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">
{{csrf_field()}}                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input class="form-control" title="Enter only letters" name="name" type="text" id="name">
                                </div>
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="{{route('training-types.index')}}" type="button" class="btn btn-default btn-flat">Cancel</a>
                                </div>                            </form>
                        </div>
                    </div>
                </div>
