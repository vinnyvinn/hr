                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">New Recruitment Process</h3>
                        </div>
                        <div class="box-body">
                            <form method="POST" action="{{route('recruitment.store')}}" accept-charset="UTF-8" encrypt="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control"  id="recruitment_type" name="recruitment_type">
                                        ...
                                        <option value="{{$recruitmenttype->id}}">{{$recruitmenttype->name}}</option>
                                            @endforeach
                                    </select>
                                </div>
